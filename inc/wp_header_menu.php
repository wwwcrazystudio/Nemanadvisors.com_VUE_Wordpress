...
class header_bem_walker extends Walker_Nav_Menu
{
    ...
    function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
    {
        ...
        if ($args->has_children) {
            $item_output .= '<div class="' . $prefix . '__sub-menu-toggler"></div>';
        }
        $item_output .= '</a>';
...
function header_bem_menu($location = "main_menu", $css_class_prefix = 'main-menu', $css_class_modifiers = null)
{
    ...
    $args = array(
        ...
        'walker'            => new header_bem_walker($css_class_prefix, true)
    );
