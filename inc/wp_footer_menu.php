...
class footer_bem_walker extends Walker_Nav_Menu
{
    ...
    function start_lvl(&$output, $depth = 1, $args = array())
    {
        ...
        $output .= '<div class="' . $prefix . '__sub-menu-wrap">';
        $output .= '<div class="' . $prefix . '__sub-menu-head">
                    <div class="' . $prefix . '__sub-menu-title">'.apply_filters('the_title', $item->title, $item->ID).'</div>
                        <button class="' . $prefix . '__sub-menu-back">
                            <svg width="24" height="12" viewBox="0 0 24 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M5.985 4.5H24V7.5H5.985V12L0 6L5.985 0V4.5Z" fill="#F2632B" />
                            </svg>
                        </button>
                    </div>';
    ...
    function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
    {
        ...
        $link_classes = array(
            ...
            'depth_class'           => $depth >= 1 ? $prefix . $suffix['sub_link'] . ' ' . $prefix . $suffix['sub_menu'] . '--' . $depth . $suffix['link'] : '',
        );
...
function footer_bem_menu($location = "main_menu", $css_class_prefix = 'main-menu', $css_class_modifiers = null)
{
    ...
    $args = array(
        ...
        'container'         => false,
        'items_wrap'        => '<ul class="' . $css_class_prefix . '__menu ' . $modifiers . '">%3$s</ul>',
        'walker'            => new footer_bem_walker($css_class_prefix, true)
    );
